...
function WishlistPage() {
  ...
  return (
    <div className="min-h-screen bg-shopping-theme flex items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-5xl w-full bg-white rounded-xl shadow-lg p-10 z-10 relative mx-auto">
        <h2 className="text-3xl font-bold mb-8 text-center bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">My Wishlist</h2>
        {wishlist.length === 0 ? (
          <div className="text-center py-20 text-gray-500 bg-white rounded-xl shadow">Your wishlist is empty.</div>
        ) : (
